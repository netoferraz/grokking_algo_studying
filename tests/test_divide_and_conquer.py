from ch04.divide_and_conquer import recursive_sum, recursive_count_items, recursive_max_value, quick_sort
import pytest
...
@pytest.mark.parametrize('expected, test_input', [([1,2,3], [3,2,1]), ([5], [5]), ([2,8,10], [8,2,10]), ([2,3,5,10,20], [10,5,3,2,20])])
def test_quick_sort(expected, test_input):
    assert expected  == quick_sort(test_input)